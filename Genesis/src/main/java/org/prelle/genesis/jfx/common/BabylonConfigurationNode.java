...
public class BabylonConfigurationNode extends StackPane implements ResponsiveControl {
	...
	private void initComponents() {
		deGeneral  = new Label(GUICOMMON.getString("configdesc.babylon"));
		 ...
		 * Language
		 */
		lbLanguage = new Label(GUICOMMON.getString("label.language"));
...
//				return optLanguage.getValueConverter().toString(loc);
				return GUICOMMON.getString("language."+loc.getLanguage());
			}
			public Locale fromString(String string) {return optLanguage.getValueConverter().fromString(string);}
		});
		deLanguage = new Label(GUICOMMON.getString("configdesc.babylon.language"));
		...
		btnDatadir = new Button(GUICOMMON.getString("label.select"));
		...
		deDataDir  = new Label(GUICOMMON.getString("configdesc.babylon.dataDir"));
		...
		deAskOnStartup = new Label(GUICOMMON.getString("configdesc.babylon.rules.askOnStartUp"));
	...
	private void initLayoutWide() {
		Label headBabylon = new Label(GUICOMMON.getString("configsection.babylon"));
	...
	private void initInteractivity() {
		...
		btnDatadir.setOnAction(event -> {
			...
			chooser.setInitialDirectory(new File(dataDir));
			 chooser.setTitle(GUICOMMON.getString("generalsettingsscreen.changedatadir.title"));
